...
// Codex) have Persona write the base file and SDD/memory append to it. If
// SDD or memory ran before Persona, Persona would overwrite those sections.
//
...
var softOrderingPairs = [][2]model.ComponentID{
	...
	{model.ComponentPersona, model.ComponentMarkdownMemory},
